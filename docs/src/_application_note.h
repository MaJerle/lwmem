 ...
 *
 *  - <a href="https://github.com/MaJerle/lwmem"><b>lwmem</b></a>: Source code of library itself.
 *      - Repository is required when developing final project
 *
 *  - <a href="https://github.com/MaJerle/lwmem_res"><b>lwmem_res</b></a>: Resources, development code,
 *      documentation sources, examples, code snippets, etc.
 *      - This repository uses `lwmem` repository as `submodule`
 ...
 *  - Run `git clone --recurse-submodules https://github.com/MaJerle/lwmem_res` command to clone repository including submodules
 ...
 *  - Download and install `git` if not already
 *  - Open console and navigate to path in the system to clone repository to. Use command `cd your_path`
 *  - Run `git clone --recurse-submodules https://github.com/MaJerle/lwmem` command to clone repository
 *
 * \par             Already cloned, update to latest version
 *
